...
export class GlobalErrorHandler implements ErrorHandler {
  ...
  showAlertIfNotPresent() {
    ...
    this.alertElement = document.createElement('ion-alert') as HTMLIonAlertElement;

    this.alertElement.backdropDismiss = false;
    this.alertElement.header = "Shucks!";
    this.alertElement.message = "There is still the chance it's not completly broken, choose wisely."
